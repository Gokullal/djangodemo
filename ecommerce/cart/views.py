...
def order_form(request):
    if(request.method=="POST"):
        ...
        client=razorpay.Client(auth=('rzp_test_Kow9r95eeASwza','XSdFoEQ6uD2t7rv0t68L7NCz'))
        #using razorpay id and secret code

        response_payment=client.order.create(dict(amount=total1,currency="INR")) #order crete
